...
import { RANKS, LEGENDARY_GRADIENTS, getRank } from "@/lib/game-ranks";
import { getScores, ScoreEntry } from "@/lib/supabase";
      ...
      <section className="mb-12">
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <div className="text-muted space-y-2">
            ...
            <p className="mt-4">
              Цель — убрать все плитки с поля до истечения времени.
            </p>
            <p className="mt-4">
              <strong className="text-foreground">Система очков:</strong>
            </p>
            <ul className="list-disc list-inside ml-4 space-y-1">
              <li>Чем больше расстояние между плитками при сбросе, тем больше очков</li>
              <li>Перемещение плиток даёт штраф к очкам</li>
              <li>За оставшееся время начисляется бонус</li>
            </ul>
          </div>
        </div>
      </section>
