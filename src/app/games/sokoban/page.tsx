...
// Классические уровни из коллекции Microban (David Skinner) - гарантированно решаемы
// Формат: # стена, @ игрок, + игрок на цели, $ ящик, * ящик на цели, . цель, пробел - пол
const LEVELS: { name: string; data: string; par: number }[] = [
  // Уровень 1 - простое введение (Microban #1)
  {
    name: "Старт",
    par: 4,
    data: `
...
`
  ...
  // Уровень 2 - два ящика в ряд (Microban #3)
  {
    name: "Пара",
    par: 8,
    data: `
...
`
  ...
  // Уровень 3 - L-образный (Microban #6)
  {
    name: "Уголок",
    par: 12,
    data: `
...
`
  ...
  // Уровень 5 - развилка (Microban #12)
  {
    name: "Развилка",
    par: 18,
    data: `
...
`
  ...
  // Уровень 6 - классика (Microban #15)
  {
    name: "Классика",
    par: 24,
    data: `
...
`
  ...
  // Уровень 9 - три ящика (Microban #30)
  {
    name: "Тройка",
    par: 42,
    data: `
...
`
  ...
  // Уровень 10 - лабиринт (Microban #35)
  {
    name: "Лабиринт",
    par: 50,
    data: `
...
`
  ...
  // Уровень 11 - хранилище (Microban #40)
  {
    name: "Хранилище",
    par: 58,
    data: `
...
`
  ...
  // Уровень 13 - сложный (Microban #50)
  {
    name: "Арена",
    par: 80,
    data: `
...
`
  ...
  // Уровень 14 - эксперт (Microban #55)
  {
    name: "Эксперт",
    par: 95,
    data: `
