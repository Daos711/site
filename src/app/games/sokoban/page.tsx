...
// Классические уровни Sokoban (формат: # стена, @ игрок, + игрок на цели, $ ящик, * ящик на цели, . цель, пробел - пол)
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      >
        ...
        {/* Победа */}
        {won && (
          <div className="absolute inset-0 bg-black/80 rounded-xl flex flex-col items-center justify-center animate-fade-in">
