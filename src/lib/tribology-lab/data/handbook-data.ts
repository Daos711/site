...
export const HANDBOOK_MODULES: Record<ModuleType, HandbookModuleData> = {
  filter: {
    ...
    role: 'DPS',
    attackType: 'single',
    description: 'Точечная атака по одному врагу. Бонус +25% урона по пыльным.',
    keyEffect: null,
    synergies: [
      'Эффективен против Пыли и Абразива',
    ],
    notes: [
      'Самый дешёвый DPS модуль',
      '+25% урона по врагам с тегом «пыльный»',
...
export const HANDBOOK_ENEMIES: Record<string, HandbookEnemyData> = {
  ...
  abrasive: {
    name: 'Абразив',
    category: 'elite',  // ИСПРАВЛЕНО: был common
    tag: 'dusty',
    description: 'Медленный, крепкий. Уязвим к Фильтру и Сепаратору.',
    immunities: [],
    counters: ['Фильтр (+25%)', 'Сепаратор (+50%)', 'Анализатор (+25%)'],
  },
  heat: {
    name: 'Перегрев',
    category: 'common',
  ...
  metal: {
    ...
    category: 'elite',
    tag: 'metal',
    description: 'Элитный враг с бронёй. Уязвим к Сепаратору и Лазеру.',
    immunities: [],
    counters: ['Сепаратор (+50%)', 'Лазер (+30%)', 'Ультразвук (снять броню)'],
  },
  corrosion: {
    name: 'Коррозия',
    category: 'elite',
  ...
  static: {
    ...
    immunities: [],
    counters: ['Барьер (блокирует)', 'Центрифуга (откат)', 'Высокий DPS'],
  },
  boss_wear: {
    name: 'Задир',
    category: 'boss',
    ...
    immunities: [],
    counters: ['Анализатор (+25%)', 'Сепаратор (+50%)', 'Концентрированный огонь'],
  },
  boss_pitting: {
    name: 'Питтинг',
    category: 'boss',
    ...
    immunities: [],
    counters: ['Ингибитор (блок регена)', 'Высокий DPS', 'Анализатор'],
  },
};
...
export const HANDBOOK_EFFECTS: Record<string, HandbookEffectData> = {
  ...
  dry: {
    name: 'Высушивание',
    icon: '💨',  // Одиночная иконка
    category: 'status',
    description: 'Снимает иммунитет к замедлению у влажных врагов.',
    target: 'Враги',
    stacking: 'Повторное попадание обновляет таймер',
    cap: null,
    sources: ['Деэмульгатор'],
    immunities: [],
    notes: 'Позволяет замедлять Влагу на 50%',
  },
  ...
  pushback: {
    ...
    icon: '↩️',
    category: 'status',
    description: 'Отталкивает врага назад по пути. Не визуальный статус — враг физически откатывается.',
    target: 'Враги',
    stacking: 'Кулдаун 1.5 сек между откатами',
    cap: null,
    sources: ['Центрифуга'],
    immunities: ['Элитные (50% сопротивление)', 'Боссы (80% сопротивление)'],
    notes: 'Это не иконка над врагом, враг физически откатывается назад',
  },
  ...
  corrosion_aura: {
    ...
    target: 'Модули',
    stacking: 'Стакается (больше врагов = сильнее штраф)',
    cap: null,
  ...
  lubricant_buff: {
    ...
    stacking: 'Берётся лучшая Смазка',
    cap: null,
    sources: ['Смазка'],
    immunities: [],
  ...
  moisture_immunity: {
    ...
    icon: '💧',  // Одиночная иконка (капля = влага)
    category: 'immunity',
  ...
  heat_immunity: {
    ...
    icon: '🌡️',  // Одиночная иконка (термометр = перегрев)
    category: 'immunity',
