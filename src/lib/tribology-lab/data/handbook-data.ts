...
export const HANDBOOK_MODULES: Record<ModuleType, HandbookModuleData> = {
  ...
  ultrasonic: {
    ...
    role: 'DPS',
    attackType: 'aoe',
    description: 'Урон по площади. Накладывает резонанс: +15% урона от всех источников.',
    keyEffect: 'resonance',
    synergies: [
      'Анализатор + Ультразвук → +25% (метка) + 15% (резонанс) = +40%',
      'Смазка + Ультразвук → +15% (покрытие) + 15% (резонанс) = +30%',
    ],
    notes: [
      'Радиус поражения: 120 px (L1) → 192 px (L5)',
      '+20% урона по пыльным',
      'Резонанс: +15% получаемого урона (3 сек)',
...
export const HANDBOOK_EFFECTS: Record<string, HandbookEffectData> = {
  ...
  resonance: {
    ...
    sources: ['Ультразвук'],
    immunities: [],
    notes: 'Стакается с Меткой (+25%) и Покрытием (+15%) для максимального урона',
  },
